...
class _OrderScreenState extends State<OrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate the height of the fixed bottom button section
    // Assuming the ElevatedButton inside has a fixed height of 56
    // And the container has fixed vertical padding of 16 (top) + 16 (bottom)
    // The total fixed height of the button container itself (excluding SafeArea's contribution) is 56 + 16 + 16 = 88
    const double bottomButtonContainerFixedHeight = 88.0;
          ...
          Expanded(
            child: ListView(
              padding: const EdgeInsets.symmetric(horizontal: 24.0)
                  .copyWith(bottom: bottomButtonContainerFixedHeight), // Padding to account for the fixed bottom button
              children: [
    ...
    return Row(
      children: [
        ClipRRect(
          borderRadius: BorderRadius.circular(8),
          child: Image.asset(
            'assets/images/I189_285_417_715.png', // Corrected image asset path (assuming this is the correct placeholder)
            width: 54,
            height: 54,
            fit: BoxFit.cover,
          ),
  ...
  Widget _buildOrderButton() {
    return SafeArea(
      bottom: true,
      child: Container(
        padding: const EdgeInsets.fromLTRB(24, 16, 24, 16), // Fixed internal padding
        decoration: BoxDecoration(
          color: Colors.white,
